<div class="container">
	<div class="collection">
		 <a href="?controller=User&action=GuardarUsuario" class="collection-item black-text"><b>Crear Usuario</b></a>

		 <a href="?controller=User&action=CargarOpcion&opcion=VerUsuarios" class="collection-item black-text"><b>Ver Usuarios</b></a>
